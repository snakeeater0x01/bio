    ...
    var u = {
        ...
        loadValidation: function() {
            void 0 !== m.fn.validate && (m(".wpforms-input-temp-name").each(function(e, t) {
                ...
                return e === m(t).closest(".wpforms-field").find("input:first-child").val()
                ...
                var r = m(t),
                    ...
                    t = r.data("max-time"),
                    r = r.prop("required");
                return void 0 === a || (!(r || !u.empty(e)) || (u.compareTimesGreaterThan(t, a) ? u.compareTimesGreaterThan(e, a) && u.compareTimesGreaterThan(t, e) : u.compareTimesGreaterThan(e, a) && u.compareTimesGreaterThan(e, t) || u.compareTimesGreaterThan(a, e) && u.compareTimesGreaterThan(t, e)))
            }, function(e, t) {
                var r = m(t),
                    t = r.data("min-time"),
                    r = r.data("max-time"),
                ...
                return t = t.replace(/(am|pm)/g, " $1").toUpperCase(), r = r.replace(/(am|pm)/g, " $1").toUpperCase(), wpforms_settings.val_time_limit.replace("{minTime}", t).replace("{maxTime}", r)
            }), m.validator.addMethod("check-limit", function(e, t) {
                var r = m(t).closest("ul"),
                    t = r.find('input[type="checkbox"]:checked'),
                    r = parseInt(r.attr("data-choice-limit") || 0, 10);
                return 0 === r || t.length <= r
            }, function(e, t) {
                    ...
                    t = void 0 !== f["wpforms_" + t] && f["wpforms_" + t].hasOwnProperty("validate") ? f["wpforms_" + t].validate : "undefined" != typeof wpforms_validate ? wpforms_validate : {
                        ...
                        highlight: function(e, t, r) {
                            var a = m(e),
                                ...
                                e = a.attr("name");
                            ("radio" === a.attr("type") || "checkbox" === a.attr("type") ? o.find('input[name="' + e + '"]') : a).addClass(t).removeClass(r), o.addClass("wpforms-has-error")
                        },
                        unhighlight: function(e, t, r) {
                            var a = m(e),
                                o = a.closest(".wpforms-field"),
                                e = a.attr("name");
                            ("radio" === a.attr("type") || "checkbox" === a.attr("type") ? o.find('input[name="' + e + '"]') : a).addClass(r).removeClass(t), o.removeClass("wpforms-has-error")
                        },
                        ...
                        onfocusout: function(e) {
                            var t = !1;
                            m(e).hasClass("wpforms-novalidate-onkeyup") && !e.value && (t = !0), (t = !this.checkable(e) && (e.name in this.submitted || !this.optional(e)) ? !0 : t) && this.element(e)
                        },
                        onclick: function(e) {
                            var t = !1,
                                r = (e || {}).type,
        ...
        loadDatePicker: function() {
            void 0 !== m.fn.flatpickr && m(".wpforms-datepicker-wrap").each(function() {
                var a = m(this),
                    ...
                    t = void 0 !== f["wpforms_" + t + "_" + r] && f["wpforms_" + t + "_" + r].hasOwnProperty("datepicker") ? f["wpforms_" + t + "_" + r].datepicker : void 0 !== f["wpforms_" + t] && f["wpforms_" + t].hasOwnProperty("datepicker") ? f["wpforms_" + t].datepicker : "undefined" != typeof wpforms_datepicker ? wpforms_datepicker : {
                        disableMobile: !0
                    };
                !t.hasOwnProperty("locale") && "undefined" != typeof wpforms_settings && wpforms_settings.hasOwnProperty("locale") && (t.locale = wpforms_settings.locale), t.wrap = !0, t.dateFormat = e.data("date-format"), 1 === e.data("disable-past-dates") && (t.minDate = "today");
                var o = e.data("limit-days"),
                    i = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"];
                o && "" !== o && (o = o.split(","), t.disable = [function(e) {
                    for (var t in o)
                        if (i.indexOf(o[t]) === e.getDay()) return !1;
                    return !0
                }]), t.onChange = function(e, t, r) {
                    t = "" === t ? "none" : "block";
        ...
        loadTimePicker: function() {
            void 0 !== m.fn.timepicker && m(".wpforms-timepicker").each(function() {
                var e = m(this),
                    ...
                    t = void 0 !== f["wpforms_" + t + "_" + r] && f["wpforms_" + t + "_" + r].hasOwnProperty("timepicker") ? f["wpforms_" + t + "_" + r].timepicker : void 0 !== f["wpforms_" + t] && f["wpforms_" + t].hasOwnProperty("timepicker") ? f["wpforms_" + t].timepicker : "undefined" != typeof wpforms_timepicker ? wpforms_timepicker : {
                        scrollDefault: "now",
                        forceRoundTime: !0
                    };
                e.timepicker(t)
            ...
            wpforms_settings.mailcheck_enabled && void 0 !== m.fn.mailcheck && (0 < wpforms_settings.mailcheck_domains.length && (Mailcheck.defaultDomains = Mailcheck.defaultDomains.concat(wpforms_settings.mailcheck_domains)), 0 < wpforms_settings.mailcheck_toplevel_domains.length && (Mailcheck.defaultTopLevelDomains = Mailcheck.defaultTopLevelDomains.concat(wpforms_settings.mailcheck_toplevel_domains)), m(s).on("blur", ".wpforms-field-email input", function() {
                ...
                e.mailcheck({
                    suggested: function(e, t) {
                        t.address.match(/^xn--/) && (t.full = punycode.toUnicode(decodeURI(t.full)), a = t.full.split("@"), t.address = a[0], t.domain = a[1]), t.domain.match(/^xn--/) && (t.domain = punycode.toUnicode(decodeURI(t.domain)));
        ...
        loadChoicesJS: function() {
            "function" == typeof f.Choices && m(".wpforms-field-select-style-modern .choicesjs-select, .wpforms-field-payment-select .choicesjs-select").each(function(e, t) {
                var r = f.wpforms_choicesjs_config || {},
                    a = m(t).data("search-enabled");
        ...
        bindUIActions: function() {
            m(s).on("click", ".wpforms-page-button", function(e) {
                ...
                var e = m(this),
                    ...
                    i = e.closest("form.wpforms-form").find(".wpforms-submit-container"),
                    s = i.find("button.wpforms-submit"),
                    e = i.prev();
                t.each(function() {
                    for (var e = m(this), t = 0, r = e[0].files.length; t < r; t++) a += e[0].files[t].size
                }), r < a ? (a = Number((a / 1048576).toFixed(3)), r = Number((r / 1048576).toFixed(3)), o = o.replace(/{totalSize}/, a).replace(/{maxSize}/, r), e.hasClass("wpforms-error-container") ? (e.find(".wpforms-error-container-post_max_size").remove(), e.append(o)) : i.before('<div class="wpforms-error-container">{errorMsg}</span></div>'.replace(/{errorMsg}/, o)), s.prop("disabled", !0)) : (e.find(".wpforms-error-container-post_max_size").remove(), s.prop("disabled", !1))
        ...
        optinMonsterRecaptchaReset: function(e) {
            var t, r = m("#om-" + e).find(".wpforms-form"),
                a = r.find(".wpforms-recaptcha-container"),
                o = r.find(".g-recaptcha");
            r.length && o.length && (e = o.attr("data-sitekey"), t = "recaptcha-" + Date.now(), r = a.hasClass("wpforms-is-hcaptcha") ? hcaptcha : grecaptcha, o.remove(), a.prepend('<div class="g-recaptcha" id="' + t + '" data-sitekey="' + e + '"></div>'), r.render(t, {
                sitekey: e,
                callback: function() {
        ...
        amountTotal: function(e, r) {
            ...
            var a = m(e).closest(".wpforms-form"),
                t = u.getCurrency(),
                e = u.amountTotalCalc(a),
                e = u.amountFormat(e),
                o = "left" === t.symbol_pos ? t.symbol + " " + e : e + " " + t.symbol;
        ...
        numberFormat: function(e, t, r, a) {
            ...
            var o = isFinite(+e) ? +e : 0,
                ...
                s = void 0 === a ? "," : a,
                e = void 0 === r ? "." : r,
                o = (i ? (t = o, a = i, r = Math.pow(10, a), "" + (Math.round(t * r) / r).toFixed(a)) : "" + Math.round(o)).split(".");
            return 3 < o[0].length && (o[0] = o[0].replace(/\B(?=(?:\d{3})+(?!\d))/g, s)), (o[1] || "").length < i && (o[1] = o[1] || "", o[1] += new Array(i - o[1].length + 1).join("0")), o.join(e)
        },
        empty: function(e) {
        ...
        currentIpToCountry: function(r) {
            function t() {
                m.get("https://ipapi.co/jsonp", function() {}, "jsonp").always(function(e) {
                    ...
                    t || (t = -1 < (e = u.getFirstBrowserLanguage()).indexOf("-") ? e.split("-").pop() : ""), r(t)
                })
            }
        ...
        formSubmitAjax: function(o) {
            ...
            return i.css("opacity", .6), s.show(), u.clearFormAjaxGeneralErrors(o), (e = new FormData(o.get(0))).append("action", "wpforms_submit"), e.append("page_url", f.location.href), e = {
                ...
                complete: function(e, t) {
                    var r, a;
                    e.responseJSON && e.responseJSON.data && e.responseJSON.data.action_required || ((a = (r = o.find(".wpforms-submit")).data("submit-text")) && r.text(a), r.prop("disabled", !1), i.css("opacity", ""), s.hide(), o.trigger("wpformsAjaxSubmitCompleted", [e, t]))
                }
