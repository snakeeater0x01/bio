...
! function() {
    ...
    function n(e) {
        ...
        if ("off-canvas" === e) {
            ...
            s = document.querySelector(".ast-mobile-header-content") || !1, e = document.querySelector(".ast-desktop-header-content") || !1;
            if (s) {
    ...
    "" !== (u = null != i ? i.querySelector("#ast-mobile-header") : u) && null !== u && (c = u.dataset.type), document.addEventListener("astMobileHeaderTypeChange", e, !1), popupTriggerClick = function(e) {
    ...
    window.addEventListener("resize", function() {
        ...
        var e;
        AstraToggleSetup(), null !== (e = d.classList.contains("ast-header-break-point") ? document.getElementById("ast-mobile-header") : document.getElementById("ast-desktop-header")) && function(e, t) {
            if (e && t) {
                var a = t.getElementsByTagName("button")[0];
                if (void 0 !== a || void 0 !== (a = t.getElementsByTagName("a")[0])) {
                    ...
                    if (void 0 !== n) {
                        n.setAttribute("aria-expanded", "false"), -1 === n.className.indexOf("nav-menu") && (n.className += " nav-menu"), "off-canvas" === c && (document.getElementById("menu-toggle-close").onclick = function() {
                            -1 !== e.className.indexOf("toggled") ? (e.className = e.className.replace(" toggled", ""), a.setAttribute("aria-expanded", "false"), n.setAttribute("aria-expanded", "false")) : (e.className += " toggled", a.setAttribute("aria-expanded", "true"), n.setAttribute("aria-expanded", "true"))
                        }), a.onclick = function() {
                            -1 !== e.className.indexOf("toggled") ? (e.className = e.className.replace(" toggled", ""), a.setAttribute("aria-expanded", "false"), n.setAttribute("aria-expanded", "false")) : (e.className += " toggled", a.setAttribute("aria-expanded", "true"), n.setAttribute("aria-expanded", "true"))
                        };
        ...
        }(e.querySelector(".navigation-accessibility"), e)
    });
    var o = function() {
    ...
    o(), AstraToggleSubMenu = function(e) {
        ...
        else if (0 < (t = (e = "off-canvas" === c || "full-width" === c ? document.querySelectorAll("#ast-mobile-popup, #ast-mobile-header") : document.querySelectorAll("#ast-mobile-header"), document.querySelectorAll("#ast-mobile-header .main-header-menu-toggle"))).length)
            for (var a = 0; a < t.length; a++)
