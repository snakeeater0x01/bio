! function(t, e) {
    if ("function" == typeof define && define.amd) define(["jquery"], e);
        ...
        e(t.jQuery), t.jqueryAsPieProgressEs = {}
    }
}(this, (function(t) {
    "use strict";
    ...
    var u = function() {
        ...
        f = function(t, e, i, n) {
            ...
            return t === e && i === n ? {
                ...
                fn: function(h) {
                    return o(function(e) {
                        for (var n, h, u, l = e, f = 0; f < 4; ++f) {
                            var c = (n = l, 3 * s(h = t, u = i) * n * n + 2 * a(h, u) * n + r(h));
                            if (0 === c) return l;
                            l -= (o(l, t, i) - e) / c
                        }
                        return l
        ...
        d = function() {
            ...
            return n(t, [{
                ...
                value: function() {
                    ...
                    }), this.buildTrack(), this.buildBar(), (0, i.default)('<div class="' + this.classes.svg + '"></div>').append(this.svg).appendTo(this.$element))
                }
            }, {
                key: "buildTrack",
                value: function() {
                ...
                value: function(t) {
                    var e, i = this;
                    this._clear(), "string" == typeof(e = t) && -1 !== e.indexOf("%") && (t = parseInt(t.replace("%", ""), 10), t = Math.round(this.min + t / 100 * (this.max - this.min))), void 0 === t && (t = this.goal), t > this.max ? t = this.max : t < this.min && (t = this.min), this.barGoal < t && this._drawBar(t);
                    var n = i.now,
                        s = u(),
                        a = s + 100 * Math.abs(n - t) * i.options.speed / (i.max - i.min);
                    i._frameId = window.requestAnimationFrame((function e(r) {
                        var o = void 0;
                        if (r > a) o = t;
                        else {
                            var h = (r - s) / i.options.speed;
                            o = Math.round(i.easing.fn(h / 100) * (i.max - i.min)), t > n ? (o = n + o) > t && (o = t) : (o = n - o) < t && (o = t)
                        }
                        i._update(o), o === t ? (window.cancelAnimationFrame(i._frameId), i._frameId = null, i.now === i.goal && i._trigger("finish")) : i._frameId = window.requestAnimationFrame(e)
                    }))
                }
            }, {
                key: "_update",
                ...
                key: "destroy",
                value: function() {
                    this.$element.data("asPieProgress", null), this._trigger("destroy")
                }
            }], [{
                key: "registerEasing",
                value: function(t) {
                    for (var e = arguments.length, i = Array(e > 1 ? e - 1 : 0), n = 1; n < e; n++) i[n - 1] = arguments[n];
                    c[t] = f.apply(void 0, i)
                }
            }, {
                key: "getEasing",
                value: function(t) {
                ...
                key: "setDefaults",
                value: function(t) {
                    i.default.extend(!0, m, i.default.isPlainObject(t) && t)
                }
            }]), t
        }(),
        g = "asPieProgress",
        p = i.default.fn.asPieProgress,
        v = function(t) {
            for (var e = arguments.length, n = Array(e > 1 ? e - 1 : 0), s = 1; s < e; s++) n[s - 1] = arguments[s];
            if ("string" == typeof t) {
                var a = t;
                if (/^_/.test(a)) return !1;
                if (!/^(get)/.test(a)) return this.each((function() {
                    var t = i.default.data(this, g);
                    t && "function" == typeof t[a] && t[a].apply(t, n)
                }));
                var r = this.first().data(g);
                if (r && "function" == typeof r[a]) return r[a].apply(r, n)
            }
            return this.each((function() {
                (0, i.default)(this).data(g) || (0, i.default)(this).data(g, new d(this, t))
            }))
        };
    i.default.fn.asPieProgress = v, i.default.asPieProgress = i.default.extend({
        setDefaults: d.setDefaults,
        registerEasing: d.registerEasing,
        getEasing: d.getEasing,
        noConflict: function() {
            return i.default.fn.asPieProgress = p, v
        }
    }, {
        version: "0.4.7"
    })
